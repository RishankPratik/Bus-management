...
if cursor.fetchone()[0]!=1:
    ...
    cursor.execute("""insert into customer values(1,1,'wils@gmail.com',19,'Wilson Vidyut','Doloy',8287528598)""")
    cursor.execute("""insert into customer values(2,2,'yankush@gmail.com',18,'Yankush','Kumar',9956874512)""")
    cursor.execute("""insert into customer values(3,3,'rishank@gmail.com',17,'Rishank','Pratik',8956457815)""")
    cursor.execute("""insert into customer values(4,4,'aditya@gmail.com',20,'Aditya','Mishra',8974859625)""")
        ...
        while True:
            ...
            if selection==1:
                                    ...
                                    while True:
                                        ...
                                        if access==1:
                                            ...
                                            for row in cursor.fetchall():
                                                ...
                                                cursor.execute("""select email,age,first_n,last_n,phone from customer """)
                                    ...
                                    def custMenu():
                                        ...
                                        while True:
                                            ...
                                            if access1==1:
                                                ...
                                                coupon=random.randint(500,999)
                                                cursor.execute("""select count(*) from one_way_booking;""")
                                                x=cursor.fetchall()
                                                y=(1000+x[0][0])
                                                trav_id=y
                                                cursor.execute("""insert into payment(seat_number,meal,baggage,tcode,traveller_id) values(?,?,?,?,?)""",(seat,meal,bag,y,trav_id))
                                                cursor.execute("""insert into ticket values(?,?,?,?)""",(y,coupon,total_price,price))
                                                ...
                                                n=n[0][0]
                                                for i in range(0,n):
                                                    cursor.execute("""select first_n from customer;""")
                                                    tfn=cursor.fetchall()
                                                    cursor.execute("""select second_n from customer;""")
                                                    tsn=cursor.fetchall()
                                                    cursor.execute("""select age from customer;""")
                                                    ta=cursor.fetchall()
                                                    ...
                                                    print(y,tfn[i][0],tsn[i][0],ta[i][0],te[i][0],tp[i][0])
                                                    cursor.execute("""insert into traveller(traveller_id,tfname,tlname,tage,temail,tphone) values (?,?,?,?,?,?)""",(y,tfn[i][0],tsn[i][0],ta[i][0],te[i][0],tp[i][0]))
                                            
                                                #cursor.execute("""insert into traveller(traveller_id,tfname,tlname,tage,temail,tphone) values (?,(select first_n from customer),(select second_n from customer),(select age from customer),(select email from customer),(select phone from customer))""",(y))
                                                ...
                                                seat=random.randint(1,60)
                                                coupon=random.randint(500,999)
                                                cursor.execute("""select count(*) from two_way_booking;""")
                                                x=cursor.fetchall()
                                                y=(2000+x[0][0])
                                                trav_id=y
                                                cursor.execute("""insert into payment(seat_number,meal,baggage,tcode,traveller_id) values(?,?,?,?,?)""",(seat,meal,bag,y,trav_id))
                ...
                for row in cursor.fetchall():
                    ...
                    print("Meal: ",row[1])
                    print("Baggage: ",row[2])
                    cursor.execute("""select coupon_code,net_price,price from ticket where ticketcode=(?)""",(t_id,))
